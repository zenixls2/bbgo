...
func init() {
	AddStatementMigration("main", 20260826090000, "migrations/sqlite3/20260826090000_private_order_fill_events.sql", true,
		...
		[]rockhopper.Statement{
			{Direction: rockhopper.DirectionDown, SQL: "DROP TABLE IF EXISTS `private_order_fill_events`;"},
		},
	)
}
